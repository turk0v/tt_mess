# tt_mess
Для запуска склонировать репозиторий и выполнить команду `flask run`
...
---
### 1 задание 
#### Откатиться до коммита: e759bc3989300efa30c3187799a5b6730be83486 или ветка hw1
...
* Для запуска memcached использовать `brew services start memcached`
...
---
### 2 задание
#### Откатиться до коммита: afc58bdb926712a419b734744af89312e371a5be или ветка 2hw2
...
* Тест `python tests/general_tests/json_comparer_test.py`
2. Selenium тест
...
---
### 3 задание 
#### Откатиться до коммита: 2909d74a9dee711281b06d90ceebb20eadfa3df4 или ветка 2hw3
...
---
### 4 задание 
#### Откатиться до коммита: 09c716c726476d2d95a35a0997b0a836c7d76ca4 или ветка 2hw4
...
---
### 5 задание
#### Откатиться до коммита: 103c89647bb0c0f37976c6abf1bf6fe4845e616a или ветка 2hw5
...
* Нужно запустить команду `celery -A app.celery beat` и воркер
...
---
### 6 задание
#### Откатиться до коммита: aca9cbd4cf940af0dae96f0a075c6f95646f4488 или ветка 2hw6
...
Для запуска на сервере использовать `sudo nginx` и `gunicorn wsgi:app -b localhost:8000` из директории проекта
